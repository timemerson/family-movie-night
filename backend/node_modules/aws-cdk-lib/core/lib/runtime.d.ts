 ...
 */
export declare function eventPatternToCloudFormation(x: any): any;
/**
 ...
 */
export declare function ensureStringOrUndefined(value: any, propName: string, possibleType: string): string | undefined;
/**
 ...
 *
 */
export declare function mapArrayInPlace<T, U extends T>(arr: T[], mapper: (item: T) => U): U[];
export declare function mapArrayInPlace<T, U extends T>(arr: T[] | undefined, mapper: (item: T) => U): U[] | undefined;
